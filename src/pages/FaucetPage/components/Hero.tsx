...
export default function Hero() {
  ...
  return (
    <section className="h-[85vh] text-front flex flex-col items-center p-20 gap-y-10 relative">
      <div className="flex text-4xl items-center gap-x-3 relative">
        {/* <img src="logo.png" className="h-[1.3em]" /> */}
        <h1 className="font-semibold">frxETH and (Dummy)FRAX Faucet</h1>
        <button
          onClick={() =>
          ...
          className="text-xs whitespace-nowrap bg-white text-black font-medium py-1 absolute bottom-0 left-full px-3 mx-7"
        >
          Add Frax to wallet
        </button>
      </div>

      <section className="flex flex-row-reverse gap-x-10">
