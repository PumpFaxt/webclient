...
const abi = [
  {
    inputs: [
      { internalType: "address", name: "fraxAddress_", type: "address" },
    ],
  ...
  {
    inputs: [{ internalType: "uint256", name: "newCharge_", type: "uint256" }],
  ...
  {
    inputs: [{ internalType: "uint256", name: "newMaxium_", type: "uint256" }],
  ...
  {
    inputs: [{ internalType: "uint256", name: "newMinimum_", type: "uint256" }],
